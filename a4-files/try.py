...
class TransformerModel(nn.Module):
    ...
    def __init__(self, ntoken, ninp, nhead, nhid, nlayers, dropout=0.5):
        """
        :param ntoken: the size of vocabulary
        ...
        encoder_layers: an instance of the TransformerEncoderLayer() class (required).
        ...
        ninp: the size of each embedding vector
        """
        self.ninp = ninp
...
"""
get_tokenizer: Generate tokenizer function for a string sentence.
"""
